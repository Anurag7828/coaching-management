												...
												<div class="row">
													...
													<div class="col-md-4">
														<div class="mb-3">
															...
															<input type="text" name="phone" value="<?= $user[0]['phone'] ?>" class="form-control" pattern="[0-9]{10}">
														</div>
													</div>
													<div class="col-md-4">
														<div class="mb-3">
															...
															<input type="text" name="alt_phone" value="<?= $user[0]['alt_phone'] ?>" class="form-control" pattern="[0-9]{10}">
														</div>
													</div>
													<div class="col-md-4">
														<div class="mb-3">
