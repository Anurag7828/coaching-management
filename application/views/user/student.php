...
<body>
    ...
    <?php include('includes2/sidebar.php') ?>
							...
							<div class="row align-items-center">
								<div class="col-sm-6">
									<ul class="contact-breadcrumb">
										<li><a href="companies.html"><i class="ti ti-arrow-narrow-left"></i>Student</a>
										</li>
								...
								<div class="d-flex align-items-center justify-content-between flex-wrap">
									<div class="d-flex align-items-center mb-2">
										<div class="avatar avatar-xxl me-3 flex-shrink-0 border p-2">
											<img src="<?=base_url()?>assets/img/icons/company-icon-01.svg" alt="Image">
										</div>
										<div>
											<h5 class="mb-1"><?= $student[0]['name']?> (<?= $student[0]['gender']?>)</h5>
											

											<p class="mb-2">Student Id :- <?= $student[0]['student_id']?> </p>
											<p class="d-inline-flex align-items-center mb-0">Student Code :- <?= $student[0]['student_code']?> </p>
										</div>
									</div>
                                    ...
                                    <?php if($student[0]['branch_id']=='0') { ?>
										...
										<a href="<?= base_url('Admin_Dashboard/deactivestudent/' . $student[0]['id'] . '/' . encryptId($user[0]['id'])); ?>" class="btn btn-success">
											Active
										</a>
                                        <?php } else {?>
                                            <a href="<?= base_url('Admin_Dashboard/activestudent/' . $student[0]['id'] . '/' . encryptId($user[0]['id'])); ?>" class="btn btn-danger">
											Deactive
										</a>
                                        <?php } ?>
										<a href="<?php echo base_url() . 'Admin_Dashboard/update_student/' . encryptId($student[0]['id']) . '/' . encryptId($user[0]['id']) . '?tag=' . $student[0]['status']; ?>" class="btn-icon" ><i class="ti ti-edit-circle"></i></a>
										<div class="act-dropdown">
											<a href="#" data-bs-toggle="dropdown" aria-expanded="false">
												<i class="ti ti-dots-vertical"></i>
											</a>
											<div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item" href="<?php echo base_url() . 'Admin_Dashbaord/view_student/' . encryptId($user[0]['id']) . '?BdID=' . $student[0]['id'] . '&tag=' . $student[0]['status']; ?>"
													><i
							...
							<div class="card-body p-3">
								...
								<div class="mb-3">
									<div class="d-flex align-items-center mb-3">
										...
										<p><a href="" class="__cf_email__" data-cfemail="97d9f8e1f6c0d7f2eff6fae7fbf2b9f4f8fa"> <?= $student[0]['email']?></a></p>
									</div>
									<div class="d-flex align-items-center mb-3">
										<span
											class="avatar avatar-xs bg-light-300 p-0 flex-shrink-0 rounded-circle text-dark me-2">
								...
								<ul>
									<li class="row mb-3"><span class="col-6">Father Name</span><span
											class="col-6"> <?= $student[0]['f_name']?></span></li>
									<li class="row mb-3"><span class="col-6">Mother Name</span><span class="col-6"> <?= $student[0]['m_name']?></span></li>
									<li class="row mb-3"><span class="col-6">Contact No.</span><span class="col-6">
                                    <?= $student[0]['parents_phone']?></span></li>
									<li class="row mb-3"><span class="col-6">Email</span><span class="col-6"> <?= $student[0]['parents_email']?></span></li>
								</ul>
                                <hr>
								<h6 class="mb-3 fw-semibold">Address Information</h6>
								<ul>
									<li class="row mb-3"><span class="col-6">Local</span><span
											class="col-6"> <?= $student[0]['address']?></span></li>
									<li class="row mb-3"><span class="col-6">Pincode</span><span class="col-6"> <?= $student[0]['pincode']?></span></li>
									<li class="row mb-3"><span class="col-6">City</span><span class="col-6">
                                    <?= $student[0]['city']?></span></li>
									<li class="row mb-3"><span class="col-6">State</span><span class="col-6"> <?= $student[0]['state']?></span></li>
                                    <li class="row mb-3"><span class="col-6">Country</span><span class="col-6"> <?= $student[0]['country']?></span></li>
								</ul>
							</div>
						</div>
					</div>
												...
												<div class="card-body p-3">
													<div class="d-flex">
														...
														<div>
															...
															<p class="mb-1">Duration :- <?= $course[0]['duration']?> <?= $course[0]['duration_type']?> </p>
												...
												<div class="card-body p-3">
													<div class="d-flex">
                                                        ...
                                                        <?php $batch = $this->CommonModal->getRowById('batchs', 'id', $student[0]['batch_id']); ?>
															...
															<p class="mb-1">Starting Time :- <?= date("h:i A", strtotime($batch[0]['starting_time'])); ?></p>
															<p class="mb-1">Ending Time :- <?= date("h:i A", strtotime($batch[0]['ending_time'])); ?></p>
																		...
																		<div class="dropdown">
																			<a href="#" class="dropdown-toggle"
																				...
																				aria-expanded="false"><img
																					src="<?=base_url()?>assets/img/profiles/avatar-19.jpg"
																			...
																			<div
																				...
																				<a class="dropdown-item"
																					href="javascript:void(0);">
																					<img src="<?=base_url()?>assets/img/profiles/avatar-19.jpg"
																						alt="img" class="avatar-xs">John
																				</a>
																				<a class="dropdown-item"
																					href="javascript:void(0);">
																					<img src="<?=base_url()?>assets/img/profiles/avatar-15.jpg"
																						alt="img"
																						class="avatar-xs">Peter
																				</a>
																			</div>
																		</div>
																	</div>
													...
													<div class="d-flex align-items-center justify-content-between pb-2">
														<div class="d-inline-flex align-items-center mb-2">
															<span class="avatar avatar-md me-2 flex-shrink-0">
																<img src="<?=base_url()?>assets/img/profiles/avatar-19.jpg" alt="img">
															</span>
															<div>
														...
														<div class="note-download">
															<div class="note-info">
																<span class="note-icon">
																	<img src="<?=base_url()?>assets/img/media/media-35.jpg" alt="img">
																</span>
																<div>
											...
											<div class="card mb-3">
												<div class="card-body">
													<div class="d-flex align-items-center justify-content-between pb-2">
														<div class="d-inline-flex align-items-center mb-2">
															<span class="avatar avatar-md me-2 flex-shrink-0">
																<img src="<?=base_url()?>assets/img/profiles/avatar-20.jpg" alt="img">
															</span>
															<div>
											...
											<div class="card mb-0">
												<div class="card-body">
													<div class="d-flex align-items-center justify-content-between pb-2">
														<div class="d-inline-flex align-items-center mb-2">
															<span class="avatar avatar-md me-2 flex-shrink-0">
																<img src="<?=base_url()?>assets/img/profiles/avatar-21.jpg" alt="img">
															</span>
															<div>
											...
											<div class="card-body">
												<div class="d-sm-flex align-items-center justify-content-between pb-2">
													<div class="d-flex align-items-center mb-2">
														...
														<p><span class="text-dark fw-medium">Vaughan Lewis</span> logged a
													...
													<div class="col-md-8">
														<div class="mb-3">
															...
															<div class="d-flex align-items-center">
																<span class="avatar avatar-md me-2 flex-shrink-0">
																	<img src="<?=base_url()?>assets/img/profiles/avatar-21.jpg"
												...
												<div class="row align-items-center">
													<div class="col-md-8">
														<div class="mb-3">
															...
															<div class="d-flex align-items-center">
																<span class="avatar avatar-md me-2 flex-shrink-0">
																	<img src="<?=base_url()?>assets/img/profiles/avatar-01.jpg"
																		alt="img" class="rounded-circle">
																</span>
																<div>
																	<span class="fs-12">Owner</span>
												...
												<div class="row align-items-center">
													<div class="col-md-8">
														<div class="mb-3">
															...
															<div class="d-flex align-items-center">
																<span class="avatar avatar-md me-2 flex-shrink-0">
																	<img src="<?=base_url()?>assets/img/profiles/avatar-22.jpg"
																		alt="img" class="rounded-circle">
																</span>
																<div>
																	<span class="fs-12">Owner</span>
		...
		<div class="modal custom-modal fade modal-padding" id="add_notes" role="dialog">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="https://crms.dreamstechnologies.com/html/template/company-details.html">
							<div class="mb-3">
											...
											<div class="col-md-6">
												<div class="mb-3">
													...
													<select class="select">
														<option>Select</option>
														<option>Admin</option>
														<option>Jackson Daniel Byrne</option>
													</select>
												</div>
											</div>
											<div class="col-md-12">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="success-message text-center">
							...
							<p>Email Account is configured with “<a href="https://crms.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="bcd9c4ddd1ccd0d9fcd9c4ddd1ccd0d992dfd3d1">[email&#160;protected]</a>”. Now you can access email.</p>
							<div class="col-lg-12 text-center modal-btn">
								<a href="company-details.html" class="btn btn-primary">Go to email</a>
							</div>
						</div>
					</div>
				</div>
								...
								<ul>
									<li class="select-people-checkbox">
										<label class="checkboxs">
											...
											<span class="people-profile">
												<img src="<?=base_url()?>assets/img/profiles/avatar-19.jpg" alt="">
									...
									<li class="select-people-checkbox">
										<label class="checkboxs">
											...
											<span class="checkmarks"></span>
											<span class="people-profile">
												<img src="<?=base_url()?>assets/img/profiles/avatar-20.jpg" alt="">
												<a href="#">Sharon Roy</a>
											</span>
										</label>
									</li>
									<li class="select-people-checkbox">
										<label class="checkboxs">
											...
											<span class="checkmarks"></span>
											<span class="people-profile">
												<img src="<?=base_url()?>assets/img/profiles/avatar-21.jpg" alt="">
									...
									<li class="select-people-checkbox">
										<label class="checkboxs">
											...
											<span class="checkmarks"></span>
											<span class="people-profile">
												<img src="<?=base_url()?>assets/img/profiles/avatar-01.jpg" alt="">
									...
									<li class="select-people-checkbox">
										<label class="checkboxs">
											...
											<span class="checkmarks"></span>
											<span class="people-profile">
												<img src="<?=base_url()?>assets/img/profiles/avatar-16.jpg" alt="">
									...
									<li class="select-people-checkbox">
										<label class="checkboxs">
											...
											<span class="checkmarks"></span>
											<span class="people-profile">
												<img src="<?=base_url()?>assets/img/profiles/avatar-22.jpg" alt="">
		...
		<div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="offcanvas_edit">
			...
			<div class="offcanvas-body">
				<form action="https://crms.dreamstechnologies.com/html/template/companies.html">
										...
										<div class="col-md-6">
											<div class="fmb-3">
												...
												<select class="select-img">
													<option data-image="<?=base_url()?>assets/img/profiles/avatar-14.jpg" selected>
														Hendry Milner</option>
													<option data-image="<?=base_url()?>assets/img/profiles/avatar-15.jpg">Guilory Berggren
													</option>
													<option data-image="<?=base_url()?>assets/img/profiles/avatar-16.jpg">Jami Carlile</option>
													<option data-image="<?=base_url()?>assets/img/profiles/avatar-13.jpg">Theresa Nelson
													</option>
													<option data-image="<?=base_url()?>assets/img/profiles/avatar-24.jpg">Smith Cooper
													</option>
												</select>
											</div>
										</div>
										...
										<div class="col-md-12">
											<div class="mb-3">
												...
												<select class="multiple-img" multiple="multiple">
													<option data-image="<?=base_url()?>assets/img/profiles/avatar-19.jpg">Darlee
														Robertson</option>
													<option data-image="<?=base_url()?>assets/img/profiles/avatar-20.jpg" selected>
														Sharon Roy</option>
													<option data-image="<?=base_url()?>assets/img/profiles/avatar-21.jpg">Vaughan Lewis
													</option>
													<option data-image="<?=base_url()?>assets/img/profiles/avatar-23.jpg">Jessica Louise
													</option>
													<option data-image="<?=base_url()?>assets/img/profiles/avatar-16.jpg">Carol Thomas
													</option>
												</select>
											</div>
										</div>
		...
		<div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="offcanvas_add_2">
			...
			<div class="offcanvas-body">
				<form action="https://crms.dreamstechnologies.com/html/template/contacts.html">
					<div class="row">
						<div class="col-md-12">
							<div class="mb-3">
						...
						<div class="col-md-12">
							<div class="mb-3">
								...
								<select class="multiple-img" multiple="multiple">
									<option data-image="<?=base_url()?>assets/img/profiles/avatar-19.jpg" selected>Darlee Robertson
									</option>
									<option data-image="<?=base_url()?>assets/img/profiles/avatar-20.jpg">Sharon Roy</option>
									<option data-image="<?=base_url()?>assets/img/profiles/avatar-21.jpg">Vaughan Lewis</option>
									<option data-image="<?=base_url()?>assets/img/profiles/avatar-23.jpg">Jessica Louise</option>
									<option data-image="<?=base_url()?>assets/img/profiles/avatar-16.jpg">Carol Thomas</option>
								</select>
							</div>
							<div class="mb-3">
						...
						<div class="col-md-12">
							<div class="mb-3">
								...
								<select class="multiple-img" multiple="multiple">
									<option data-image="<?=base_url()?>assets/img/profiles/avatar-19.jpg">Darlee Robertson</option>
									<option data-image="<?=base_url()?>assets/img/profiles/avatar-20.jpg" selected>Sharon Roy</option>
									<option data-image="<?=base_url()?>assets/img/profiles/avatar-21.jpg">Vaughan Lewis</option>
									<option data-image="<?=base_url()?>assets/img/profiles/avatar-23.jpg">Jessica Louise</option>
									<option data-image="<?=base_url()?>assets/img/profiles/avatar-16.jpg">Carol Thomas</option>
								</select>
	...
	<!-- jQuery -->
	<script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="<?=base_url()?>assets/js/jquery-3.7.1.min.js" ></script>
...
<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="c437fe80f96e304f0c16e4c8-|49" defer></script></body>
