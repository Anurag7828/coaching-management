                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-8">
                                        <div
                                            ...
                                            <a href="<?= base_url('Admin_Dashboard/add_course/'. encryptId($user[0]['id']))?>" class="btn btn-primary"><i
...
<?= base_url('Admin_Dashboard/deactivecourse/' . $row['id'].'/'.encryptId($user[0]['id'])); ?>"><i
                                                                            class="ti ti-eye text-danger"></i>Deactive</a>
                                                                            <?php } else{ ?>
                                                                                <a class="dropdown-item" href="
<?= base_url('Admin_Dashboard/activecourse/' . $row['id'].'/'.encryptId($user[0]['id'])); ?>"><i
                                                                            class="ti ti-eye text-success"></i>Active</a>
                                                                            <?php } ?>
                                                                    <a class="dropdown-item"
                                                                        href="<?php echo base_url() . 'Admin_Dashboard/update_course/' . $row['id'].'/'.encryptId($user[0]['id']) .'?tag='. $row['status']; ?>"><i
                                                                            class="ti ti-edit text-blue"></i> Edit</a>
                                                                    <a class="dropdown-item" href="
<?php echo base_url() . 'Admin_Dashboard/view_course/'.encryptId($user[0]['id']).'?BdID=' . $row['id'] . '&tag=' .  $row['status'];?>"><i
