...
<body>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-7 col-sm-8">
                                                    ...
                                                    <div class="text-sm-end">
                                                        <button id="downloadExcel" class="btn btn-primary">Download
                                                            Sample Excel</button>
                                                    </div>
                                        ...
                                        <div class="accordion-body border-top">
                                            <div class="row">
                                                ...
                                                <div class="d-flex align-items-center justify-content-end">
                                                    ...
                                                    <button id="uploadCSVBtn" class="btn btn-primary">Upload
                                                        CSV</button>
                                                </div>
    ...
    document.getElementById('uploadCSVBtn').addEventListener('click', function () {
        ...
        fetch(base_url + "Admin_Dashboard/upload_emp_attendance_csv", {
            method: "POST",
            body: formData
        })
        ...
        .then(data => {
            ...
            if (data.status) {
                ...
                var user_id = "<?php echo encryptId($user[0]['id']); ?>";
                
window.location.href = base_url + "Admin_Dashboard/view_emp_attendance/" + user_id;
        ...
        <script>
            document.getElementById('downloadExcel').addEventListener('click', function () {
                ...
                fetch(base_url + 'Admin_Dashboard/get_emp?user_id=' + user_id)
                    ...
                    .then(data => {
                        if (data.status && Array.isArray(data.data) && data.data.length > 0) {
                            ...
                            // Add CSV Header
                            csvContent += "Employee ID,Employee Code,Employee Name,Inst ID,Department ID, Department Name ,Date,Status\n";
