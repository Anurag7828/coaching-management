												...
												data-bs-target="#add_department" class="com-add"><i
													class="ti ti-circle-plus me-1"></i>Add New</a>
                                                            <select class="select2 form-control" name="batch_id"
                                                                >
                                                                <option value="N/A" <?= ($tag == 'edit' && isset($timetable[0]['batch_id']) && $timetable[0]['batch_id'] == 'N/A') ? 'selected' : '' ?>
                                                                    data-display="Please select">Choose</option>
                                                                <?php if (!empty($batch)): ?>
                                                                    <?php foreach ($batch as $item): ?>

                                                                        <option value="<?= $item['id'] ?>" <?= ($tag == 'edit' && isset($timetable[0]['batch_id']) && $timetable[0]['batch_id'] == $item['id']) ? 'selected' : '' ?> data-display="Please select">
                                                                            <?= $item['name'] ?>
                                                                        </option>
                                                                    <?php endforeach; ?>
                                                                <?php endif; ?>
                                                            ...
                                                            <input type="hidden" class="form-control" name="inst_id" value="<?= ($tag == 'edit' && isset($timetable[0]['inst_id'])) ? htmlspecialchars($timetable[0]['inst_id']) : $user[0]['id'] ?>" required>
 <input type="hidden" class="form-control" name="emp_id" value="<?= ($tag == 'edit' && isset($timetable[0]['emp_id'])) ? htmlspecialchars($timetable[0]['emp_id']) : $emp_id ?>" required>
                                                        </div>
                                                    </div>
                                                    <?php else: ?>
                                                           <div class="col-md-4">
												...
												data-bs-target="#add_department" class="com-add"><i
													class="ti ti-circle-plus me-1"></i>Add New</a>
                                                            <select class="select2 form-control" name="emp_id"
                                                                >
                                                                <option value="N/A" <?= ($tag == 'edit' && isset($timetable[0]['emp_id']) && $timetable[0]['emp_id'] == 'N/A') ? 'selected' : '' ?>
                                                                    data-display="Please select">Choose</option>
                                                                <?php if (!empty($employee)): ?>
                                                                    <?php foreach ($employee as $item): ?>

                                                                        <option value="<?= $item['id'] ?>" <?= ($tag == 'edit' && isset($timetable[0]['emp_id']) && $timetable[0]['emp_id'] == $item['id']) ? 'selected' : '' ?> data-display="Please select">
                                                                            <?= $item['name'] ?>
                                                                        </option>
                                                                    <?php endforeach; ?>
                                                                <?php endif; ?>
                                                            ...
                                                            <input type="hidden" class="form-control" name="inst_id" value="<?= ($tag == 'edit' && isset($timetable[0]['inst_id'])) ? htmlspecialchars($timetable[0]['inst_id']) : $user[0]['id'] ?>" required>
 <input type="hidden" class="form-control" name="batch_id" value="<?= ($tag == 'edit' && isset($timetable[0]['batch_id'])) ? htmlspecialchars($timetable[0]['batch_id']) : $batch_id ?>" required>
                                                        </div>
                                                    </div>
                                                    <?php endif; ?>
    ...
    <?php if (!empty($course)): ?>
        <?php foreach ($course as $item): ?>
            <option value="<?= $item['id'] ?>" <?= ($tag == 'edit' && isset($timetable[0]['course_id']) && $timetable[0]['course_id'] == $item['id']) ? 'selected' : '' ?>>
                <?= $item['name'] ?>
            </option>
        <?php endforeach; ?>
    <?php endif; ?>
    ...
    <option value="N/A">Choose Subject</option>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="time" class="form-control" name="starting_time" value="<?= ($tag == 'edit' && isset($timetable[0]['starting_time'])) ? htmlspecialchars($timetable[0]['starting_time']) : '' ?>" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            class="text-danger">*</span></label>
                                                            <input type="time" class="form-control" name="ending_time" value="<?= ($tag == 'edit' && isset($timetable[0]['ending_time'])) ? htmlspecialchars($timetable[0]['ending_time']) : '' ?>" required>
                                                        </div>
                                                    </div>
                                                    <!-- <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <option value="N/A" <?= ($tag == 'edit' && isset($timetable[0]['course_id']) && $timetable[0]['course_id'] == 'N/A') ? 'selected' : '' ?> data-display="Please select">Choose</option>
                                                            <?php if (!empty($course)) : ?>
                                                                <?php foreach ($course as $item) : ?>

                                                                <option value="<?= $item['id'] ?>" <?= ($tag == 'edit' && isset($timetable[0]['course_id']) && $timetable[0]['course_id'] == $item['id']) ? 'selected' : '' ?> data-display="Please select"> <?= $item['plan_name'] ?></option>
                                                                <?php endforeach; ?>
                                                                <?php endif; ?>
