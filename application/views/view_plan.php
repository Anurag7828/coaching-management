                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-8">
                                        <div
                                            ...
                                            <a href="<?= base_url() ?>add_plan" class="btn btn-primary"><i
                                                    class="ti ti-square-rounded-plus me-2"></i>Add Plan</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- /Search -->
...
<?= base_url('Home/deactiveplan/' . $row['id']); ?>"><i
                                                                            class="ti ti-eye text-danger"></i>Deactive</a>
                                                                            <?php } else{ ?>
                                                                                <a class="dropdown-item" href="
<?= base_url('Home/activeplan/' . $row['id']); ?>"><i
                                                                            class="ti ti-eye text-success"></i>Active</a>
                                                                            <?php } ?>
                                                                    <a class="dropdown-item"
                                                                        href="<?php echo base_url() . 'Home/update_plan/' . $row['id']. '?tag='. $row['status']; ?>"><i
                                                                            class="ti ti-edit text-blue"></i> Edit</a>
                                                                    <a class="dropdown-item" href="
<?php echo base_url() . 'view_plan?BdID=' . $row['id'] . '&tag=' .  $row['status'];?>"><i
