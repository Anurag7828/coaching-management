							...
							<div class="card-body pb-2">
								<div class="d-flex align-items-center justify-content-between flex-wrap">
									<div class="d-flex align-items-center mb-2">
										...
										<div>
											<h5 class="mb-1"><?= $user[0]['name'] ?> (<?= $user[0]['gender'] ?>)
											</h5>
											<p class="mb-2">Roll No. :- <?= $user[0]['roll_no'] ?> </p>

											<p class="mb-2">Student Id :- <?= $user[0]['student_id'] ?> </p>
									...
									<div class="contacts-action">
										...
										<?php } ?>
										<?php $batch = $this->CommonModal->getRowById('batchs', 'id', $user[0]['batch_id']); ?>
										<a href="#" class="btn btn-info">
											<?= $batch[0]['name']; ?>
										</a>
										<?php if ($user[0]['status'] == '0') { ?>
											<a href="<?= base_url('Admin_Dashboard/deactivestudent/' . $user[0]['id'] . '/' . encryptId($clg[0]['id'])); ?>"
												class="btn btn-success">
												Active
											</a>
										<?php } else { ?>
											<a href="<?= base_url('Admin_Dashboard/activestudent/' . $user[0]['id'] . '/' . encryptId($clg[0]['id'])); ?>"
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="contact-activity">
											...
											<?php $course = $this->CommonModal->getRowById('courses', 'id', $user[0]['course_id']); ?>
													...
													<div class="table-responsive mb-3">
														<table class="table">
															...
															<tbody>
																...
																$fees_type = $this->CommonModal->getRowById('student_fees', 'student_id', $user[0]['id']);
																...
																<?php
																$payment = $this->CommonModal->getRowByIdOrderByLimit('fees_payment', 'student_id', $user[0]['id'], 'inst_id', $clg['0']['id'], 'id', 'DESC', '1');
																$paymentsum = $this->CommonModal->getRowByIdSum('fees_payment', 'student_id', $user[0]['id'], 'inst_id', $clg['0']['id'], 'paid');
																?>
																<tr>
											...
											<div class="card-body">
												...
												<div class="table-responsive mb-3">
													<table class="table">
														...
														<tbody>
															<?php
															$paymentall = $this->CommonModal->getRowByMultitpleId('fees_payment', 'student_id', $user[0]['id'], 'inst_id', $clg[0]['id'], 'id', 'DESC');
															$i = 0;
									...
									<div class="card-body">
										<div class="card border mb-0">
											<div class="card-body pb-0">
												<?php $emails = $this->CommonModal->getRowByMultitpleId('student_email', 'student_id', $user[0]['id'], 'inst_id', $clg[0]['id'], 'id', 'DESC');
												if (!empty($emails)) {
							...
							<div class="tab-pane fade" id="attendence">
								<div class="card">
									<div
										...
										<div class="d-inline-flex align-items-center">
											<a href="<?= base_url('Admin_Dashboard/attendence_report/' . encryptId($clg[0]['id']) . '/' . encryptId($user[0]['id'])); ?>" class="com-add"><i
										...
										<div class="card mb-3">
											<div class="card-body">
												<div class="border-bottom mb-3">
													...
													$this->db->where('student_id', $user[0]['id']);
																...
																<select class="form-control" name="account_id"
																	...
																	foreach ($account as $account_info) { ?>
																		<option value="<?= $account_info['id'] ?>"
																			<?= ($tag == 'edit' && isset($user_payment[0]['account_id']) && $user_payment[0]['account_id'] == $account_info['id']) ? 'selected' : '' ?>>
