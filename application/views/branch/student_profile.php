												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="mb-3">
															...
															<input type="text" name="roll_no" value="<?= $user[0]['roll_no'] ?>" class="form-control">
														</div>
													</div>
													<div class="col-md-4">
														<div class="mb-3">
												...
												<div class="row">
													...
													<div class="col-md-3">
														<div class="mb-3">
															...
															<input type="text" class="form-control" name="gender" value="<?= $user[0]['gender'] ?>">
														</div>
													</div>
													<div class="col-md-3">
														<div class="mb-3">
															<label class="form-label">Date of Birth<span class="text-danger">*</span></label>
															<input type="text" class="form-control" name="dob" value="<?= $user[0]['dob'] ?>">
														</div>
													</div>
													...
													<div class="col-md-3">
														<div class="mb-3">
															...
															<input type="text" class="form-control" name="adhar_no" value="<?= $user[0]['adhar_no'] ?>">
														</div>
													</div>
													<div class="border-bottom mb-3 pb-3">
														...
														<div class="row">
															<div class="col-md-3">
																<div class="mb-3">
																	...
																	<input type="text" class="form-control" name="f_name" value="<?= $user[0]['f_name'] ?>">
																</div>
															</div>
															<div class="col-md-3">
																<div class="mb-3">
																	<label class="form-label">Mother Name<span class="text-danger">*</span></label>
																	<input type="text" class="form-control" name="m_name" value="<?= $user[0]['m_name'] ?>">
																</div>
															</div>
															<div class="col-md-3">
																<div class="mb-3">
																	<label class="form-label">Parents Email<span class="text-danger">*</span></label>
																	<input type="text" class="form-control" name="parents_email" value="<?= $user[0]['parents_email'] ?>">
																</div>
															</div>
															...
															<div class="col-md-3">
																<div class="mb-3">
																	...
																	<input type="text" class="form-control" name="parents_phone" value="<?= $user[0]['parents_phone'] ?>">
																</div>
															</div>
														</div>
													</div>
